      ...
      <div className="relative z-10">
        ...
        <div className="content-section py-8">
          ...
          <p className="section-text">
            Tailoring resumes for different positions (robotics vs. web development vs. embedded
            systems) is tedious, messy, and error-prone. People maintain multiple Word documents,
            lose track of which version they sent where, and spend hours manually rewriting the same
        ...
        <div className="content-section py-8">
          ...
          <p className="section-text">
            Once you sign up, save your complete career history. This becomes your canonical record.
            Every change you make automatically creates a working commit (no staging required). When
            you&apos;re ready, name your commit to finalize a version. Branch your resume for
