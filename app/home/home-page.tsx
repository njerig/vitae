...
export default function HomeClient({ userName, userId }: { userName: string; userId: string }) {
  ...
  if (isAuthenticated) {
    return (
      <div
        className={`min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-black flex flex-col items-center justify-start p-4 md:p-8 relative overflow-hidden`}
      >
